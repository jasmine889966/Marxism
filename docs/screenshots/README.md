...
![Routing principles and missing configuration](macos-rules-en.png)

## Link activity

![Awaiting international connection](macos-activity-en.png)

## Engineering tools

![Native engineering tools](macos-tools-en.png)
